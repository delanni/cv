...
I have a combined 12+ years of experience in working with a wide breadth of languages and technologies from Javascript/Typescript, through R, Java, to Scala, AWS and GCP; I have a confident understanding of service architecture and common patterns solutions, infrastructure, ops with AWS and GCP, and delivery processes. I take end-to-end ownership of my contribution, I stand up for my values and try to improve engineering practises around me.
...
## Senior Software Engineer - Kibana Operations @ [Elastic](https://www.elastic.co/) || 2023.05 - present

Developer-experience engineer for the Kibana project, helping developers with daily CI, build, tooling, automation, and infrastructure problems. Working on build pipelines, testing infrastructure, and developer tooling to improve the productivity and reliability of one of the largest TypeScript codebases in the world.
_(Typescript, Node.js, Python, Shell scripting, GCP, Terraform, Kubernetes, Bazel)_

## Staff Full-stack engineer (tooling) @ [Prezi](https://prezi.com/) || 2020.12 - 2022.12
